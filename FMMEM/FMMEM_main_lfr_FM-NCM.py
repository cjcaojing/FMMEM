...
LFR_path = r"data/LFRnetwork/LFR_3000_20"
...
#            for gen in range(Gen):
                ...
                if gen>30 and (((abs(abs(best_in_history_Q[gen-30]) - best_Q) <= 1.0e-7) or (best_in_history_Q[gen-30] == best_Q))) or (gen+1) % Gen ==0:
                    stop_flag=True
                    if (gen+1)<Gen:
                ...
                TCM_Flag=True if (gen>150 and gen%10==0) else False
                # 更新pop,fit
                pop = FNCM_pop
                fit = FNCM_fit
                ...
                if (gen+1)%20==0 or stop_flag:
                    ...
                    if NMIflag==1:
                        print("MAXNMI={},NMI={}".format(max(best_in_history_NMI),nmi))
